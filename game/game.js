  ...
  const mapData = {
    0: [
      ...
      { 
        ...
        display: {
          caption: `Hi, I'm a house. Do you want to come to my home?`,
          link: linkButton('../index.html', `ok!`)
    ...
    1: [
      ...
      { 
        ...
        display: {
          caption: `Hey there, do you want to go back to my home?`,
          link: linkButton('../index.html', `ok!`),
        } 
      },
      ...
      { element: 'tree', angle: 75, offset: 20 },
      {
        ...
        display: {
          ...
          caption: 'Want to know who is the Iron Man?',
          link: linkButton('../ironman/ironman.html', `yup, I'll have a look`)
        },
      },
      {
    ...
    2: [
      ...
      { 
        ...
        display: { caption: `Hello, I'm the sun. I love being your friend!` },
      },
      { 
        element: 'talking_tree', angle: 120, offset: 80, color: 'white',
        display: { caption: `I'm tree! I love being under the sun.` }
      },
